...
struct ContributionEntrySheet: View {
    ...
    private var notesSection: some View {
        VStack(alignment: .leading, spacing: WinnieSpacing.xs) {
            ...
            TextField("", text: $notes, prompt: Text("e.g., Birthday money, Tax refund").foregroundColor(WinnieColors.cardText.opacity(WinnieColors.Opacity.tertiary)), axis: .vertical)
